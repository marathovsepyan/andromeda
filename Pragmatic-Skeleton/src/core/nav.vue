	...
	>
		...
		<el-submenu index="/dashboards" popper-class="main-navigation-submenu">
			<template slot="title">
                ...
                <span class="menu-item">{{translate('Control')}}</span>
			</template>
			<el-menu-item index="/dashboard">
				<span slot="title">Blank page</span>
			</el-menu-item>
            <el-menu-item index="/dashboard1">
                <span slot="title">{{translate('CodeAndRun')}}</span>
            </el-menu-item>
            <el-menu-item index="/dashboard2">
                <span slot="title">{{translate('ScriptScheduler')}}e</span>
            </el-menu-item>
            <el-menu-item index="/dashboard3">
                <span slot="title">{{translate('DeviceSetting')}}</span>
            </el-menu-item>
            <el-menu-item index="/dashboard4">
                <span slot="title">{{translate('DebugLog')}}</span>
            </el-menu-item>
            <el-menu-item index="/dashboard5">
                <span slot="title">{{translate('ShellConsole')}}</span>
            </el-menu-item>
		</el-submenu>

        <el-menu-item index="/404">
            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M22 14L22 22L14 22L14 14L17 14L17 12L3 12L3 8L1.66948e-07 8L2.62347e-07 -2.62347e-07L8 -1.66948e-07L8 8L5 8L5 10L17 10L17 8L14 8L14 -9.5399e-08L22 0L22 8L19 8L19 14L22 14ZM20 2L20 6L16 6L16 2L20 2ZM6 6L6 2L2 2L2 6L6 6Z" fill="black"/>
            </svg>
            <span class="menu-item" slot="title">{{translate('Devices')}}</span>
        </el-menu-item>
        <el-menu-item index="/404">
            ...
            <span class="menu-item" slot="title">{{translate('Settings')}}</span>
        </el-menu-item>
